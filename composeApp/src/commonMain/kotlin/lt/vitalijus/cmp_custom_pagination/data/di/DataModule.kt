...
import lt.vitalijus.cmp_custom_pagination.data.persistence.LocalSettingsRepository
...
val dataModule = module {
    ...
    single<SettingsRepository> { LocalSettingsRepository(keyValueStorage = get()) }
